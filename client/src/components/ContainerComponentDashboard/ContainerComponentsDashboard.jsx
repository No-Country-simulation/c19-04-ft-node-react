...
const ContainerComponentsDashboard = () => {
    return (
        <div className="bg-customGray-200 w-[70vw] min-w-[70vw] max-h-[80vh] h-[80vh] border border-gray-300 rounded-lg overflow-y-scroll custom-scrollbar scroll-smooth mx-auto my-auto">
            <MenuManager />
        </div>
    );
}
