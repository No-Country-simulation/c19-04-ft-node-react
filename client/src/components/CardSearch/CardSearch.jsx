...
const CardSearch = ({title, description, timePreparation, price, imgUrl}) => {
    return (
        <div className='min-w-[270px] max-w-[270px] h-[563px] bg-customGray-50 flex flex-col items-center rounded-[22px] shadow-custom-light-focushovered p-5 '>
            ...
            <img className='w-[243px] h-[244px] -translate-y-[10%]' src={imgUrl} alt="" />
            <article className='-translate-y-[16%]'>
                <h2 className='text-2xl font-bold leading-[30.24px] '>{title}</h2>
                <p className='text-sm leading-[17.64px] text-gray-600 text-wrap line-clamp-4'>
                    {description}
                </p>
