...
export default function NavBar() {
  ...
  return (
    <div
      className={`fixed bottom-0 w-full p-2 sm:transition-all sm:duration-300 sm:absolute sm:h-full bg-customBlue-600 sm:left-0 sm:py-10 flex sm:justify-center sm:items-start ${
