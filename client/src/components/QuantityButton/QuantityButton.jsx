...
function QuantityButton({ productId }) {
	...
	return (
		<div className='rounded-[450px] h-[45px] bg-gray-400'>
			<button
				className='rounded-[450px] h-[45px] w-[45px] text-xl bg-gray-400 border border-customLight'
				onClick={() => {
			...
			<button
				className='rounded-[450px] h-[45px] w-[45px] text-customLight text-xl bg-customBlue'
				onClick={() => {
