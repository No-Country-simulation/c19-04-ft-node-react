...
import { handlerSubmitRegister, handleChangeForm } from '../../utils/functions/handlerChangeForm';
...
const RegisterUser = () => {
  ...
  return (
    <form onSubmit={handlerSubmitRegister(formData, setErrors)} className='space-y-6 p-6'>
